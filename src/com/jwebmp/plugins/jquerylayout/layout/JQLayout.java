...
import static com.jwebmp.utilities.StaticStrings.STRING_EQUALS;
...

{
	...
	{
		String sb = ((BorderLayout) getComponent()).getVariableID() + STRING_EQUALS + getComponent().getJQueryID() + "layout(" + getNewLine() + getOptions() + STRING_CLOSING_BRACKET_SEMICOLON;
		addQuery(sb);
	}
