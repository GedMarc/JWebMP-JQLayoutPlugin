...
public class JQLayoutDisableClosableFeature
		extends Feature<GlobalFeatures, JavaScriptPart, JQLayoutDisableClosableFeature>
{
	 ...
	 * @param layoutDiv
	 */
	public JQLayoutDisableClosableFeature(JQLayoutDiv layoutDiv)
	{
