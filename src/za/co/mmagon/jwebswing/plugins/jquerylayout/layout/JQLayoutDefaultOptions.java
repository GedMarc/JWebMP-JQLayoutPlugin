...
public class JQLayoutDefaultOptions extends JavaScriptPart
{
    ...
    private JQEasingEffects fxName_open;
    private JQEasingEffects fxName_close;
    ...
    private JQEasingAnimationEffectsPart fxSettings_open;
    private JQEasingAnimationEffectsPart fxSettings_close;
     ...
     * @param fxName
     */
    public void setFxName(JQEasingEffects fxName)
    {
        this.fxName = fxName;
    }
     ...
     * @return
     */
    public JQEasingEffects getFxName_open()
    {
        return fxName_open;
    }
     ...
     * @param fxName_open
     */
    public void setFxName_open(JQEasingEffects fxName_open)
    {
     ...
     * @return
     */
    public JQEasingEffects getFxName_close()
    {
        return fxName_close;
    }
     ...
     * @param fxName_close
     */
    public void setFxName_close(JQEasingEffects fxName_close)
    {
     ...
     * @param fxSettings
     */
    public void setFxSettings(JQEasingAnimationEffectsPart fxSettings)
    {
     ...
     * @return
     */
    public JQEasingAnimationEffectsPart getFxSettings_open()
    {
     ...
     */
    public void setFxSettings_open(JQEasingAnimationEffectsPart fxSettings_open)
    {
     ...
     * @return
     */
    public JQEasingAnimationEffectsPart getFxSettings_close()
    {
     ...
     */
    public void setFxSettings_close(JQEasingAnimationEffectsPart fxSettings_close)
    {
     ...
     */
    public void setResponsiveWhen(LayoutResponsiveBootstrapSize responsiveWhen)
    {
